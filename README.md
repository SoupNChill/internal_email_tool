...
[![Release](https://img.shields.io/badge/release-v0.13.1--rc.1-blue)](https://github.com/SoupNChill/internal_email_tool/releases)
...
**v0.13.1-rc.1** — feature complete and packaged. The full lifecycle (install →
